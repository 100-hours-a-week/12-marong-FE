...
export default function GroupNicknameDialog({
  open,
  setOpen,
  onSuccess,
  group,
  ...
  const { data: updateGroupProfileData, mutate: updateGroupProfile } =
    useMutation({
      ...GroupQueries.updateGroupProfile({
        groupId: group.groupId,
        nickname: fields.nickname,
        groupProfileImage: fields.groupUserProfileImage,
      }),
      onSuccess: () => {
        onSuccess && onSuccess();
        setOpen(false);
      ...
      onError: (error) => {
        console.log("updateGroupProfileError", error);
        alert(error.response.data.message);
      },
    });
            ...
            <div className="flex flex-col gap-4 mt-4">
              ...
              <div className="flex flex-row gap-2">
                ...
                <button
                  ...
                  disabled={!valid.nickname || !fields.nickname}
